...
<div id="wrapper">
	<div id="menu">
		<p class="welcome">Szyfrowanie, <b><?php echo $_SESSION['name']; ?></b></p>
	...
	<div id="menu2">
		<p class="welcome">Co było szyfrowane, <b><?php echo $_SESSION['name']; ?></b></p>
		<div style="clear:both"></div>
	</div>	
	<div id="chatbox2"><?php
	if(file_exists("log_czysty.html") && filesize("log_czysty.html") > 0){
		$handle = fopen("log_czysty.html", "r");
		$contents = fread($handle, filesize("log_czysty.html"));
		fclose($handle);
